...
def main() -> None:
    ...
    st.markdown(
        ...
        <div class="hero">
          <div>
            <div class="hero-kicker">CompanyCharts · ConsistencyScore research · synthetic ETF</div>
          ...
          <div class="hero-meta"><strong>COMPANYCHARTS</strong><br/>ConsistencyScore + %Max<br/>Research dashboard</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
