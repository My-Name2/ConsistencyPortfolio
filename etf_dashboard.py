...
def main() -> None:
    ...
    with st.expander("CompanyCharts ConsistencyScore and %Max methodology"):
        ...
        st.markdown(
            "The **TTM adjusted %Max** view is the buyback-neutral company-total version. The broader adjusted %Max view can also include margin series. This dashboard shows both when they are present in the snapshot."
        )
