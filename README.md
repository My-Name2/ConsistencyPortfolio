...
The dashboard is branded for the CompanyCharts research framework and includes the bundled `consistency_snapshot.csv`, a snapshot dated 2026-08-25. It contains the two score fields used in the research:
